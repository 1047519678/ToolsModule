webpackJsonpL2Dwidget([0], {
    79: function (t, e, i) {
        ...
        var r, o = i(26), n = i(83), s = i(80), _ = i(81), a = i(86), h = i(84), l = i(82), $ = i(39),
            u = (r = $) && r.__esModule ? r : {default: r};
        var p = null, c = void 0, f = !1, g = null, y = null, d = null, m = null, T = !1, P = .5, S = null;
        ...
        function L(t) {
            ...
            var e = n.currCanvas.getBoundingClientRect(), i = w(t.clientX - e.left), r = D(t.clientY - e.top),
                o = v({x: e.left + e.width / 2, y: e.top + e.height * P}, {x: t.clientX, y: t.clientY}, e),
                s = x(o.x - e.left), _ = I(o.y - e.top);
            l.cDefine.DEBUG_MOUSE_LOG && console.log("modelTapEvent onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"), i, r, S.emit("tap", t), p.tapEvent(s, _)
        }

        function M() {
            T && (T = !1), g.setPoint(0, 0)
        }
        ...
        function E(t) {
            if ("mousedown" == t.type) L(t); else if ("mousemove" == t.type) !function (t) {
                ...
                var e = n.currCanvas.getBoundingClientRect(), i = w(t.clientX - e.left), r = D(t.clientY - e.top),
                    o = v({x: e.left + e.width / 2, y: e.top + e.height * P}, {x: t.clientX, y: t.clientY}, e),
                    s = x(o.x - e.left), _ = I(o.y - e.top);
                l.cDefine.DEBUG_MOUSE_LOG && console.log("modelTurnHead onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"), i, r, g.setPoint(s, _)
        ...
        function A(t) {
            ...
            "touchstart" == t.type ? 1 == t.touches.length && L(h) : "touchmove" == t.type ? (e = h, i = n.currCanvas.getBoundingClientRect(), r = w(e.clientX - i.left), o = D(e.clientY - i.top), s = v({
                ...
                x: e.clientX,
                y: e.clientY
            }, i), _ = x(s.x - i.left), a = I(s.y - i.top), l.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + e.clientX + " y:" + e.clientY + " ) view( x:" + _ + " y:" + a + ")"), T && (r, o, g.setPoint(_, a))) : "touchend" == t.type && M()
        }

        function x(t) {
            var e = m.transformX(t);
            return y.invertTransformX(e)
        }

        function I(t) {
            var e = m.transformY(t);
            return y.invertTransformY(e)
        }

        function w(t) {
            return m.transformX(t)
        }

        function D(t) {
            return m.transformY(t)
        }

        e.theRealInit = function (t) {
            ...
            var e, i, r = n.currCanvas.getBoundingClientRect(), $ = r.height / r.width, T = l.cDefine.VIEW_LOGICAL_LEFT,
                P = l.cDefine.VIEW_LOGICAL_RIGHT, v = -$, L = $;
            (y = new _.L2DViewMatrix).setScreenRect(T, P, v, L), y.setMaxScreenRect(l.cDefine.VIEW_LOGICAL_MAX_LEFT, l.cDefine.VIEW_LOGICAL_MAX_RIGHT, l.cDefine.VIEW_LOGICAL_MAX_BOTTOM, l.cDefine.VIEW_LOGICAL_MAX_TOP), e = u.default.mobile() && o.config.mobile.scale || o.config.model.scale, y.adjustScale(0, 0, e), (d = new _.L2DMatrix44).multScale(1, r.width / r.height), (m = new _.L2DMatrix44).multTranslate(-r.width / 2, -r.height / 2), m.multScale(2 / r.width, -2 / r.height), s.Live2D.setGL(n.currWebGL), n.currWebGL.clearColor(0, 0, 0, 0), i = o.config.model.jsonPath, p.reloadFlg = !0, p.count++, p.changeModel(n.currWebGL, i), f || (f = !0, function t() {
                !function () {
                    h.MatrixStack.reset(), h.MatrixStack.loadIdentity(), g.update(), p.setDrag(g.getX(), g.getY()), n.currWebGL.clear(n.currWebGL.COLOR_BUFFER_BIT), h.MatrixStack.multMatrix(d.getArray()), h.MatrixStack.multMatrix(y.getArray()), h.MatrixStack.push();
                    for (var t = 0; t < p.numModels(); t++) {
                        var e = p.getModel(t);
                        if (null == e) return;
                ...
                e(t, n.currCanvas), void 0 !== c && (c(n.currCanvas.toDataURL()), c = void 0)
            }())
        ...
        var r = i(26), o = i(27), n = i(40), s = void 0, _ = void 0;
        ...
        var r = i(81), o = i(87), n = i(88), s = i(82);
        ...
        var r = i(81), o = i(89), n = i(84), s = i(82), _ = i(80);
